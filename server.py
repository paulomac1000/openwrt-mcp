...
if not os.path.exists(OPENWRT_SSH_KEY):
    print(
        f"[server] WARNING: SSH key not found at {OPENWRT_SSH_KEY} - OpenWRT features will be disabled",
        file=sys.stderr,
    )
...
if __name__ == "__main__":
    ...
    print("[server] " + "=" * 50)
    print("[server] OpenWRT-Observer MCP Server")
    print("[server] " + "=" * 50)
    ...
    print("[server]   Health:      http://0.0.0.0:9094/health")
